...
callback = [callbacks.EarlyStopping(patience=100)]
...
# result.to_csv(output_figpath / 'pred_bulk_label0_speed2.csv')


# In[5]:


result = pd.read_csv(output_figpath / 'pred_bulk_label0_speed2.csv', index_col=0)
